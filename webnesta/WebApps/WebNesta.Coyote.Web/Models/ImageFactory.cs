...
namespace WebNesta.Coyote.Web.Models
{
    public static class ImageFactory
    {
        ...
        /// </summary>
        public static Color BackgroundColor { get; set; } = ColorTranslator.FromHtml("#82BBEF");
            ...
            int fontSize, int distortion = 18, ImageFormat imgFormat = null)
        {
            ...
            using (Font txtFont = new Font(FONTFAMILY, fontSize, FontStyle.Italic))
            {
                ...
                g.DrawString(captchaCode, txtFont, Brushes.White, new PointF(0, 0));
    ...
    //            {
    //                g.Clear(BackgroundColor);
    //                g.DrawString(captchaCode, txtFont,
    //                    Brushes.White, //COR DA FONTE DO CAPTCHA
    //                    new PointF(0, 0));
    ...
    //              //
    //              //      g.DrawLine(
    //              //          Pens.Gray, //COR DOS TRAÇOS DO CAPTCHA FONTE DO CAPTCHA
