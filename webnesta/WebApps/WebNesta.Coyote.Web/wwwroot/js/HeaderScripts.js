$(document).ready(function () {
    document.getElementById("pt-BR").classList.remove("ativo");
    document.getElementById("en-US").classList.remove("ativo");
    document.getElementById("es-ES").classList.remove("ativo");
    var session = $("#hdnSession").data('value');
    if (session === "")
        document.getElementById("pt-BR").classList.add("ativo");
    else
        document.getElementById(session).classList.add("ativo");
});
